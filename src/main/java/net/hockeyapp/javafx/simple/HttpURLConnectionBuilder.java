...
public class HttpURLConnectionBuilder {
    ...
    public HttpURLConnectionBuilder writeMultipartData(Map<String, String> fields) {
        try {
    ...
    public HttpURLConnection build() throws IOException {
        ...
        if (mRequestMethod != "") {
            ...
            if (mRequestBody != "" || mRequestMethod.equalsIgnoreCase("POST") || mRequestMethod.equalsIgnoreCase("PUT")) {
